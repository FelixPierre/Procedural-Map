...
namespace HexMap {
    ...
    public class HexFeatureManager : MonoBehaviour {
        ...
        public void AddFeature(HexCell cell, Vector3 position) {
            ...
            position.y += instance.localScale.y * 0.5f; // only for default cube
        ...
        void AddWallWedge(Vector3 near, Vector3 far, Vector3 point) {
            ...
            walls.AddTriangleUnpertubed(pointTop, v3, v4);
        }
        ...
        public void AddBridge(Vector3 roadCenter1, Vector3 roadCenter2) {
            ...
            Transform instantiate = Instantiate(bridge);
            instantiate.localPosition = (roadCenter1 + roadCenter2) * 0.5f;
            instantiate.forward = roadCenter2 - roadCenter1;
            float length = Vector3.Distance(roadCenter1, roadCenter2);
            instantiate.localScale = new Vector3(1f, 1f, length * (1f / HexMetrics.bridgeDesignLength));
            instantiate.SetParent(container, false);
        }
        ...
        public void AddSpecialFeature(HexCell cell, Vector3 position) {
            ...
            instance.localPosition = HexMetrics.Perturb(position);
            HexHash hash = HexMetrics.SampleHashGrid(position);
            instance.localRotation = Quaternion.Euler(new Vector3(0f, 360f * hash.e, 0f));
            instance.SetParent(container, false);
        }
    }
